...
const programs = [
    {
        ...
        url: 'https://leonemasterschool.it/abm-re/',
    ...
    },
    {
        ...
        url: 'https://leonemasterschool.it/sales-skills-re/',
        cta: 'Vai al programma'
    },
    {
        ...
        url: 'https://leonemasterschool.it/mep-re/',
        cta: 'Vai al programma'
    },
    {
        badge: 'Coaching',
        ...
        url: 'https://leonemasterschool.it/diventa-coach-re/',
        cta: 'Vai al programma'
    },
    {
        badge: 'Immobiliare',
...
function setupEventListeners() {
    ...
    // Touch swipe (mobile) — ascoltiamo sull'intera pagina dell'iframe
    // così funziona anche quando il dito parte sopra la parte sinistra (titolo/CTA).
    let touchStartX = 0;
    let touchStartY = 0;
    let touchEndX = 0;
    let touchEndY = 0;
    ...
    const swipeTargets = [container, document.querySelector('.container'), document.body].filter(Boolean);
    ...
    function handleSwipe() {
        ...
        // Se il movimento è più verticale che orizzontale, è uno scroll — ignora.
